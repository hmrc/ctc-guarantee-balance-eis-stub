...
object TestScenarios {
  ...
  private val guaranteeData: List[TestData] = List(
    ...
    TestData(1, GuaranteeReferenceNumber("26GB000001038B634"), BigDecimal("10"), "GBP", "AC01"),
    TestData(1, GuaranteeReferenceNumber("26XI0000010943D40"), BigDecimal("10"), "GBP", "AC01")
  )
